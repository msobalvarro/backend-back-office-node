...
INSERT INTO `investment` VALUES (73,1,27,'2020-03-29 13:23:21','hash-54f5g4h6aa66asd546a',0.05,1,1),(74,2,27,'2020-03-29 13:41:07','hash-as6d54a6s4d65a4sd5as',15,1,1),(75,1,30,'2020-03-29 14:52:57','hash0-5asd46as54d65a4sd',2,1,1);
...
INSERT INTO `payments` VALUES (38,74,'2020-01-29 13:42:21',1,0.15),(39,73,'2020-03-29 13:42:45',5,0.0025),(40,73,'2020-02-29 13:43:21',50,0.025),(41,74,'2020-01-29 13:43:36',25,3.75),(42,73,'2020-01-29 13:44:00',25,0.0125),(43,75,'2020-03-20 14:53:22',1,0.02),(44,73,'2020-02-29 14:53:22',1,0.0005),(45,73,'2020-03-29 15:08:55',100,0.05),(46,75,'2020-03-29 15:08:55',100,2);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getAllRequest`()
BEGIN
	SELECT 
		plan.id as id,
		concat(inf_usr.firstname, ' ', inf_usr.lastname) as name,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getRecordDetails`(
	-- id de usuario
	in _id int
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getReportPayments`(
	in _id_currency int
)
BEGIN
	select 
...
-- Dump completed on 2020-03-29 15:30:43
