        ...
        query(getDataTrading, [id_currency], async (response) => {
            for (let index = 0; index < response[0].length; index++) {
                ...
                const msg = {
                    ...
                    html: `
                    <div
                        style="background: linear-gradient(238deg, rgba(0, 0, 0, 1) 0%, rgba(25, 24, 24, 1) 52%, rgba(21, 61, 70, 1) 100%); padding: 25px; color: #ffffff; font-size: 1.2em; font-family: Arial, Helvetica, sans-serif; text-align: center;">
                        ...
                        <div style="padding: 25px; background-color: rgba(0, 0, 0, 0.2); margin-top: 10px; border-radius: 10px;">
                            <p>
