        ...
        query(getDataTrading, [id_currency], async (response) => {
            for (let index = 0; index < response[0].length; index++) {
                ...
                const msg = {
                    ...
                    html: `
                    <div
                        style="background: #161616; padding: 25px; color: #000; font-size: 1.2em; font-family: Arial, Helvetica, sans-serif; text-align: center; height: 100%;">
                        ...
                        <div
                            style="padding: 25px; background-color: #33778833; color: #FFF; margin-top: 10px; border-radius: 10px; text-transform: uppercase;">
                            <p>
