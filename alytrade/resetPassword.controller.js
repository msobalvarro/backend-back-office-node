 ...
 */
const publicKey = '6Ldx1ggcAAAAAM3dCxzYG1d4CGRcYYTRk9Fb5O9U'///"6LeTe60ZAAAAAOcLmLZ-I_EXmH1PhQwmw4Td6e3D"
...
router.post("/generate", async (req, res) => {
    try {
        ...
        if (informationUser.length === 0) {
            throw String("El correo no esta asociado a Alytrade")
        }
        ...
        const html = await getHTML("reset-password_alytrade.html", { pin: pin.toString(), name })
